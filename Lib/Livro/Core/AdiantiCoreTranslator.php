...
{
    private static ?AdiantiCoreTranslator $instance = null; // singleton instance con tipo
    private string $lang;                                   // target language
    private array $messages;
    private array $sourceMessages; // Añadida inicialización implícita como array si aplica
