...
class ProdutosList extends Page
{
    ...
    public function onReload()
    {
        ...
        // 1. Executa a Trait padrão (carrega os produtos e fecha a transação dela)
        $this->onReloadTrait();

        // 2. Abre uma nova transação rápida para buscar os fabricantes em memória
        try {
            ...
            if ($items) {
                foreach ($items as $produto) {
                    // Força o carregamento do Fabricante enquanto a transação está ativa!
