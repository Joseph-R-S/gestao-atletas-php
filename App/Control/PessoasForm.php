        ...
        try {
            if (isset($param['id'])) {
                ...
                if ($pessoa) {
                    ...
                    $dadosPuros = method_exists($pessoa, 'toArray') ? $pessoa->toArray() : (method_exists($pessoa, 'getData') ? $pessoa->getData() : get_object_vars($pessoa));
                    ...
                    foreach ($dadosPuros as $campo => $valor) {
                        ...
                        $stdObject->$campo = $pessoa->$campo;
                    }
                    
                    $stdObject->id_cidade = $pessoa->id_cidade;
